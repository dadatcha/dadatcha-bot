...
import { LayoutDashboard, Coins, Gamepad2, Bell, ScrollText, Circle, ShoppingBag, Shield, Terminal, Gift, Shuffle, Ticket, UserPlus, MessageSquareCode, Zap, ShieldAlert } from 'lucide-react';
...
const sections: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/welcome', label: 'Arrivées & Départs', icon: UserPlus },
      { path: '/custom-commands', label: 'Cmds personnalisées', icon: MessageSquareCode },
      { path: '/automod',         label: 'Automodération',      icon: ShieldAlert },
    ],
  },
];
