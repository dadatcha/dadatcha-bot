...
export const GetEconomyConfigResponse = zod.object({
  ...
  "blackjackMinBet": zod.number(),
  "blackjackMaxBet": zod.number(),
  "rouletteEnabled": zod.boolean(),
  "rouletteMinBet": zod.number(),
  "rouletteMaxBet": zod.number(),
  "hlEnabled": zod.boolean(),
  "hlMinBet": zod.number(),
  "hlMaxBet": zod.number(),
  "hlStreakReward": zod.number(),
  "guessEnabled": zod.boolean(),
  "guessMinBet": zod.number(),
  "guessMaxBet": zod.number(),
  "guessMaxAttempts": zod.number(),
...
export const UpdateEconomyConfigBody = zod.object({
  ...
  "blackjackMinBet": zod.number().optional(),
  "blackjackMaxBet": zod.number().optional(),
  "rouletteEnabled": zod.boolean().optional(),
  "rouletteMinBet": zod.number().optional(),
  "rouletteMaxBet": zod.number().optional(),
  "hlEnabled": zod.boolean().optional(),
  "hlMinBet": zod.number().optional(),
  "hlMaxBet": zod.number().optional(),
  "hlStreakReward": zod.number().optional(),
  "guessEnabled": zod.boolean().optional(),
  "guessMinBet": zod.number().optional(),
  "guessMaxBet": zod.number().optional(),
  "guessMaxAttempts": zod.number().optional(),
...
export const ListPlayersResponseItem = zod.object({
  ...
  "total": zod.number(),
  "rank": zod.number(),
  "xp": zod.number().optional().default(0),
  "level": zod.number().optional().default(0),
...
export const ListGiveawaysResponseItem = zod.object({
  ...
  "requiredRoleIds": zod.array(zod.string()),
...
export const CreateGiveawayBody = zod.object({
  ...
  "requiredRoleIds": zod.array(zod.string()).optional(),
